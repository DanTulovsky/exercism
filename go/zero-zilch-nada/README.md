...
Welcome to Zero, Zilch, Nada on Exercism's Go Track. If you need help running the tests or submitting your code, check
...
In this exercise, we will write some simple functions that return zero values for various Go types. Some types you might
not have seen before. They will be introduced in detail in later exercises.
